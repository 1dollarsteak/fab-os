...
gdt_code:      ; the code segment descriptor
               ...
               ; 1010b
               ; 2nd flags: (granularity)1 (32-bit default)1 (64-bit seg)0\
               ; (AVL)0 -> 1100b
...
gdt_end:       ; the reason for putting a label at the end of the GDT is so we
...
; Define some constants for the GDT segment descriptor offsets, which are what
